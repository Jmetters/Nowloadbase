...
module.exports = () => {
  const config = {
    ...
    styles: {
      mainSource: `${env.srcPath}/**/*.{scss,sass}`,
      source: `${env.srcPath}/style.scss`,
      lintPath: `${env.srcPath}/`,
      build: `${env.buildPath}/`,
    },
    accStyles: {
      mainSource: `${env.srcPath}/css/**/*.{scss,sass}`,
      source: `${env.srcPath}/css/acc-landing-pages.scss`,
      lintPath: `${env.srcPath}/css/`,
      build: `${env.buildPath}/css/`,
    },
    stylesDefer: {
      mainSource: `${env.srcPath}/assets/sass_defer/**/*.{scss,sass}`,
      source: `${env.srcPath}/assets/sass_defer/style.scss`,
      lintPath: `${env.srcPath}/assets/sass_defer/`,
      build: `${env.buildPath}/dist/assets/sass_defer/`,
    },
    scripts: {
    ...
    scriptsDefer: {
      source: `${env.srcPath}/assets/js_defer/**/*.js`,
      lintPath: `${env.srcPath}/assets/js_defer/`,
      build: `${env.buildPath}/dist/assets/js_defer/`,
    },
    images: {
